...
gulp.task('restore:angular2-jwt', function () {
    gulp.src([
        'node_modules/angular2-jwt/**/*.js'
    ]).pipe(gulp.dest(libs + 'angular2-jwt'));
});
//gulp.task('restore:angular2-google-recaptcha', function () {
//    gulp.src([
//        'node_modules/angular2-google-recaptcha/**/*.js'
//    ]).pipe(gulp.dest(libs + 'angular2-google-recaptcha'));
//});
gulp.task('restore:angular2-recaptcha', function () {
    gulp.src([
        'node_modules/angular2-recaptcha/**/*.js'
    ]).pipe(gulp.dest(libs + 'angular2-recaptcha'));
});
gulp.task('restore', [
    'restore:core-js',
    'restore:zone.js',
    ...
    'restore:angular',
    'restore:bootstrap',
    'restore:angular2-jwt',
    
    'restore:angular2-recaptcha'
]);